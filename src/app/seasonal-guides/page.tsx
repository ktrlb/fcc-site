    ...
    <div className="min-h-screen bg-white pt-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 font-serif mb-4">Seasonal Guides</h1>
          <p className="text-xl text-gray-600">Resources for special seasons and holidays</p>
        </div>
