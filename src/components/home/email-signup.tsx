          ...
          <CardContent className="p-0">
            ...
            <div className="text-center mb-8">
              <Button 
                asChild
                size="lg"
                className="bg-indigo-900 hover:bg-indigo-700 text-white px-12 py-4 text-lg"
              >
                <a 
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
              <div>
                <h4 className="font-semibold text-stone-900 mb-2">Weekly Newsletter</h4>
                <p className="text-sm text-stone-700">
                  Get the latest news and updates from our community
                </p>
              </div>
              <div>
                <h4 className="font-semibold text-stone-900 mb-2">Event Reminders</h4>
                <p className="text-sm text-stone-700">
                  Never miss important events and special services
                </p>
              </div>
              <div>
                <h4 className="font-semibold text-stone-900 mb-2">Prayer Requests</h4>
                <p className="text-sm text-stone-700">
